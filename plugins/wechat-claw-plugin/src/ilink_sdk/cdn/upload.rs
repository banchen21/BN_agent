...
use crate::ilink_sdk::cdn::aes_ecb::{aes_ecb_padded_size, encrypt_aes_ecb};
use crate::ilink_sdk::client::ILinkClient;
use crate::ilink_sdk::error::{Error, Result};
use crate::ilink_sdk::http_client::HttpClient;
use crate::ilink_sdk::types::{GetUploadUrlRequest, UploadMediaType};
...
pub async fn upload_bytes<H: HttpClient>(
    ...
    let upload_param = upload_url_resp.upload_param.ok_or_else(|| Error::Cdn {
