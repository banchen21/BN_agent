...
use crate::ilink_sdk::auth::credential::{AccountData, CredentialStore};
use crate::ilink_sdk::error::{Error, HttpError, Result};
use crate::ilink_sdk::http_client::HttpClient;
use crate::ilink_sdk::types::{QrCodeResponse, QrStatus, QrStatusResponse};
...
impl<'a, H: HttpClient> QrLoginSession<'a, H> {
    ...
    pub async fn wait_for_login_with(mut self, handler: &dyn LoginHandler) -> Result<LoginResult> {
